...
export default function PremiumExperiencesPage() {
  ...
  const loadExperiences = () => {
    try {
      setLoading(true)
      // Usar la función local directamente (más confiable)
      const data = getPremiumExperiences()
      setExperiences(data)
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Mesas exclusivas en los mejores restaurantes del mundo. Conocé a otros viajeros mientras disfrutás de una experiencia culinaria única.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600">No hay experiencias premium disponibles</p>
            </div>
          ) : (
